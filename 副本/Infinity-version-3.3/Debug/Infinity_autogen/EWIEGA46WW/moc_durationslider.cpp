...
QT_MOC_LITERAL(39, 13), // "s_valueSignal"
QT_MOC_LITERAL(53, 7) // "s_value"

    },
    "DurationSlider\0sliderReleasedAt\0\0value\0"
    "s_valueSignal\0s_value"
};
...
void DurationSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->s_valueSignal((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (DurationSlider::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DurationSlider::s_valueSignal)) {
                *result = 1;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<DurationSlider, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>
...
// SIGNAL 1
void DurationSlider::s_valueSignal(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
