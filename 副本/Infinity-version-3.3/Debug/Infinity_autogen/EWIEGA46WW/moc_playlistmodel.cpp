...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_PlayListModel_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_PlayListModel_t qt_meta_stringdata_PlayListModel = {
    {
QT_MOC_LITERAL(0, 13), // "PlayListModel"
QT_MOC_LITERAL(14, 14), // "changePlayList"
QT_MOC_LITERAL(29, 0) // ""

    },
    "PlayListModel\0changePlayList\0"
};
...
void PlayListModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->changePlayList(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayListModel::changePlayList)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PlayListModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_PlayListModel.offsetsAndSize,
    qt_meta_data_PlayListModel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_PlayListModel_t
, QtPrivate::TypeAndForceComplete<PlayListModel, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void PlayListModel::changePlayList()
{
