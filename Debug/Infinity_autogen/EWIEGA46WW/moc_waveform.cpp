...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Waveform_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Waveform_t qt_meta_stringdata_Waveform = {
    {
QT_MOC_LITERAL(0, 8), // "Waveform"
QT_MOC_LITERAL(9, 11), // "closeSignal"
QT_MOC_LITERAL(21, 0), // ""
QT_MOC_LITERAL(22, 7) // "onTimer"

    },
    "Waveform\0closeSignal\0\0onTimer"
};
...
void Waveform::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Waveform::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Waveform::closeSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Waveform::staticMetaObject = { {
    ...
    qt_meta_stringdata_Waveform.offsetsAndSize,
    qt_meta_data_Waveform,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Waveform_t
, QtPrivate::TypeAndForceComplete<Waveform, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
